function deltaTable = measureColorStrip00(colorRef, colorActual,isPlot)

% Input
%   colorRef : color reference in LAB Space
%   colorAct : color actual in LAB Space

[Delta_E,dl,dc,dh] = ciede00(colorActual, colorRef);
...
if isPlot
    figure;
    xyzRef = lab2xyz(colorRef);
    rgbRef = xyz2linsrgb(xyzRef);
    xyzAct = lab2xyz(colorActual);
    rgbAct = xyz2linsrgb(xyzAct);
